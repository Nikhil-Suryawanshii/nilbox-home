...
// 1. Fix: Use autoDispose and dispose the controller to prevent memory leaks/stale controllers
// final homeScrollControllerProvider = Provider.autoDispose<ScrollController>((ref) {
...
final isHomeScrolledProvider = StateProvider.autoDispose<bool>((ref) => false);
// 2. Fix: Use autoDispose so tab resets to 0 on logout/re-entry
final selectedTabIndexProvider = StateProvider.autoDispose<int>((ref) => 0);

// 3. Fix: Use autoDispose for Home Scroll state
// final isHomeScrolledProvider = StateProvider.autoDispose<bool>((ref) => false);
...
// // Provider to track if the home page is currently scrolled down
// final isHomeScrolledProvider = StateProvider<bool>((ref) => false);
//
// // All State Provider
// final homeScrollControllerProvider = Provider((ref) => ScrollController());

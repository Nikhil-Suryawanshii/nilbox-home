class MasterModel {
  MasterModel({required this.message, required this.data});
...
class Data {
  ...
  late final int minPhoneLength;
  late final int maxPhoneLength;
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    paymentGateways =
        ...
        ).map((e) => PaymentGateways.fromJson(e)).toList();
    ...
    minPhoneLength = json['phone_min_length'];
    maxPhoneLength = json['phone_max_length'];
  }
...
class Currency {
  Currency({required this.symbol, required this.position});
...
class ThemeColors {
  ...
  factory ThemeColors.fromJson(Map<String, dynamic> json) {
    return ThemeColors(primaryColor: json['primary']);
  }
}

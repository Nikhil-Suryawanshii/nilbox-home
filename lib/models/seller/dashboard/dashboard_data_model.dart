...
class DashboardDataModel {
  ...
  DashboardDataModel.fromJson(Map<String, dynamic> json) {
    ...
    pendingWithdraw =
        json['pending_withdraw'] != null
            ? PendingWithdraw.fromJson(json['pending_withdraw'])
            : null;
    maxChartAmount = json['max_chart_amount'];
    minChartAmount = json['min_chart_amount'];
    salesChartMonths = List.castFrom<dynamic, String>(
      json['sales_chart_months'],
    );
    salesChartValues = List.castFrom<dynamic, double>(
      json['sales_chart_values'],
    );
  }

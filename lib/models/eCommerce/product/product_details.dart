...
class Product {
  ...
  factory Product.fromMap(Map<String, dynamic> map) {
    return Product(
      ...
      colors: List<Color1>.from(
        (map['colors'] as List<dynamic>).map<Color1>(
          (x) => Color1.fromMap(x as Map<String, dynamic>),
        ),
      ),
...
class Color1 {
  ...
  factory Color1.fromMap(Map<String, dynamic> map) {
    return Color1(
      id: map['id'].toInt() as int,
      name: map['name'] as String,
  ...
  factory Color1.fromJson(String source) =>
      Color1.fromMap(json.decode(source) as Map<String, dynamic>);

  @override
  String toString() => 'Color(id: $id, name: $name,color_code: $colorCode,)';

  @override
  bool operator ==(covariant Color1 other) {
    if (identical(this, other)) return true;

...
import 'package:ready_ecommerce/views/common/onboarding/layouts/onboarding_view1.dart';
import 'package:ready_ecommerce/views/common/onboarding/layouts/onboarding_view2.dart';
import 'package:ready_ecommerce/views/common/onboarding/layouts/onboarding_view3.dart';
import 'package:ready_ecommerce/views/common/onboarding/layouts/onboarding_view4.dart';
...
import 'package:ready_ecommerce/views/seller/auth/confirm_otp.dart';
import 'package:ready_ecommerce/views/seller/auth/create_new_password_layout.dart';
import 'package:ready_ecommerce/views/seller/auth/forget_password.dart';
import 'package:ready_ecommerce/views/seller/auth/login.dart';
import 'package:ready_ecommerce/views/seller/auth/registration.dart';
import 'package:ready_ecommerce/views/seller/auth/under_review.dart';
import 'package:ready_ecommerce/views/seller/dashboard/dashboard.dart';
import 'package:ready_ecommerce/views/seller/dashboard/my_message/layout/my_chat_layout.dart' show SellerMyChatLayout;
import 'package:ready_ecommerce/views/seller/dashboard/my_message/layout/my_message_layout.dart';
import 'package:ready_ecommerce/views/seller/dashboard/my_message/my_chat_view.dart';
import 'package:ready_ecommerce/views/seller/dashboard/my_message/my_message_view.dart';
import 'package:ready_ecommerce/models/eCommerce/shop_message_model/user.dart';
import 'package:ready_ecommerce/views/seller/dashboard/order/screens/order_details.dart';
import 'package:ready_ecommerce/views/seller/dashboard/order/screens/orders.dart';
import 'package:ready_ecommerce/views/seller/dashboard/wallet/screens/wallet.dart';
...
class Routes {
  ...
  static const String onbarding1 = '/onboarding1';
  static const String onbarding2 = '/onboarding2';
  static const String onbarding3 = '/onboarding3';
  static const String onbarding4 = '/onboarding4';
  ...
  static const String sellerConfirmOTP = '/sellerConfirmOTP';
  static const String sellerForgotPassword = '/sellerForgotPassword';
  static const String sellerCreatePassword = '/sellerCreatePassword';
  static const String sellerUnderReview = '/sellerUnderReview';
  static const String sellerMyMessageView = '/sellerMyMessageView';
  static const String sellerMyChatView = '/sellerMyChatView';
  static const String sellerOrders = '/orders';
  static const String sellerOrderDetails = '/sellerOrderDetails';
  static const String sellerWallet = '/sellerWallet';
  
  // Dashboard for after successful seller login
  ...
  static String getSellerChatViewRouteName(String service) {
    return '$service$sellerMyChatView';
  }

  static String getSellerMyMessageViewRouteName(String service) {
    return '$service$sellerMyMessageView';
  }
...
Widget getsellerMyMessageView(String serviceName) {
  switch (serviceName) {
    case 'ecommerce':
      return const SellerMyMessageView();
    case 'food':
      return const SellerMyMessageView();
    case 'grocery':
      return const SellerMyMessageView();
...
Widget getSellerMyChatView(String serviceName, User user) {
  switch (serviceName) {
    case 'ecommerce':
      return SellerMyChatView(
        user: user,
      );
    case 'food':
      return SellerMyChatView(
...
Widget handleCommonRoutes(String? routeName, RouteSettings settings) {
  switch (routeName) {
    ...
    case Routes.onbarding1:
      return const OnboardingView1();
    case Routes.onbarding2:
      return const OnboardingView2();
    case Routes.onbarding3:
      return const OnboardingView3();
    case Routes.onbarding4:
      return const OnboardingView4();  
    case Routes.login:
    ...
    case Routes.sellerRegistration:
      return const SellerRegistration();

    case Routes.sellerConfirmOTP:
      final String email = settings.arguments as String;
      return SellerConfirmOTP(email: email);

    case Routes.sellerForgotPassword:
      return const ForgotPassowrd();

    case Routes.sellerCreatePassword:
      final String? token = settings.arguments as String?;
      return CreatePassword(token: token);

    case Routes.sellerUnderReview:
      return const SellerUnderReview();

    case Routes.sellerDashboard:
      // This is the view that contains the EcommerceSellLayout
      return const SellerDashboard(); 

    case Routes.sellerMyChatView:
      // Extract the User object from arguments
      final User? user = settings.arguments as User?;
      if (user == null) {
        throw Exception('User argument is required for SellerMyChatView');
      }
      return SellerMyChatLayout(user: user);

    case Routes.sellerOrders:
      return const Orders();

    case Routes.sellerOrderDetails:
      final int orderId = settings.arguments as int;
      return OrderDetails(orderId);

    case Routes.sellerWallet:
      return const Wallet();
...
Route generatedRoutes(RouteSettings settings) {
  ...
  // }
    ...
    return go(view, settings);
      ...
      settings.name == Routes.getSellerMyMessageViewRouteName(serviceName)) {
    final Widget view = getsellerMyMessageView(serviceName);
    return go(view, settings);
  } else if (serviceName != null &&
    ...
    return go(view, settings);
      ...
      settings.name == Routes.getSellerChatViewRouteName(serviceName)) {
    final User user = settings.arguments as User;
    final Widget view = getSellerMyChatView(serviceName, user);
    return go(view, settings);
  } else if (serviceName != null &&

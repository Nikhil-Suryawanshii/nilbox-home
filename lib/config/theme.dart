...
// Helper to access custom colors via Theme extension
AppColors colors(context) => Theme.of(context).extension<AppColors>()!;

ThemeData getAppTheme(
    {required BuildContext context, required bool isDarkTheme}) {
  
  // Dynamically fetch colors for the 'ecommerce' service (default)
  ...
  return ThemeData(
    ...
    extensions: <ThemeExtension<AppColors>>[
      AppColors(
        ...
        hintTextColor: appColor.hintTextColor,
        errorColor: appColor.errorColor,
        // containerColor: Matches card/dialog background in seller components
        containerColor: isDarkTheme ? const Color(0xFF06161C) : appColor.light,
      ),
    ],
    fontFamily: 'Mulish',
    unselectedWidgetColor: appColor.accentColor,
    ...
    colorScheme: ColorScheme(
      brightness: isDarkTheme ? Brightness.dark : Brightness.light,
      primary: appColor.primaryColor,
      onPrimary: isDarkTheme ? appColor.dark : appColor.light,
      secondary: appColor.secondaryColor,
      onSecondary: isDarkTheme ? appColor.dark : appColor.light,
      error: appColor.errorColor,
    ...
    bottomSheetTheme: BottomSheetThemeData(
      modalBarrierColor: isDarkTheme
          ? const Color(0xFF1e2420).withOpacity(0.8)
          : appColor.accentColor.withOpacity(0.8),
      backgroundColor: isDarkTheme ? EcommerceAppColor.black : EcommerceAppColor.white,
      modalBackgroundColor: isDarkTheme ? EcommerceAppColor.black : EcommerceAppColor.white,

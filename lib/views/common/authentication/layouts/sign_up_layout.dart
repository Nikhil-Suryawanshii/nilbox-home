        ...
        child: Column(
          ...
          children: [
            Text(
              ...
              style: AppTextStyle(context)
                  .title
                  .copyWith(fontWeight: FontWeight.bold,color:colors(context).light ),
            ),
            Gap(20.h),
            Text(
              S.of(context).signUpToContinue,
            ...
            Text(
              ...
              style: AppTextStyle(context)
                  .bodyText
                  .copyWith(fontWeight: FontWeight.w500,color:colors(context).light),
            ),
            Gap(5.h),
            Consumer(builder: (context, ref, child) {
              return ref.watch(countryListControllerProvider).when(
                  ...
                  data: (data) {
                    ...
                    return FormBuilderDropdown(
                      ...
                      style: TextStyle(
                          fontSize: 12, color:colors(context).dark
                      ),
                      onChanged: (value) {
                        setState(() {
                          selectedCountry = value as Country;
            ...
            Stack(
              children: [
                ...
                Positioned(
                  ...
                  top: -5,
                  child: Checkbox(
                    // activeColor: colors(context).light!,
                      side: BorderSide(color: colors(context).light!),
                      value: isChecked,
                      onChanged: (value) {
                        setState(() {
                          isChecked = value!;
